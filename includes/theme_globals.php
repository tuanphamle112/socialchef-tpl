...
class SocialChef_Theme_Globals extends SocialChef_BaseSingleton {
	...
	public function disable_amount_fractions() {
		$disable_amount_fractions = of_get_option('disable_amount_fractions', 0);
		return isset( $disable_amount_fractions ) && $disable_amount_fractions ? 1 : 0;
	}		
	
	public function enable_instructions() {
		$enable_instructions = of_get_option('enable_instructions', 1);
		return isset( $enable_instructions ) && $enable_instructions ? 1 : 0;
	}		
	
	public function enable_instruction_images() {
		$enable_instruction_images = of_get_option('enable_instruction_images', 0);
		return isset( $enable_instruction_images ) && $enable_instruction_images ? 1 : 0;
	}		

	public function enable_recipe_meta() {
		$enable_recipe_meta = of_get_option('enable_recipe_meta', 1);
		return isset( $enable_recipe_meta ) && $enable_recipe_meta ? 1 : 0;
	}	
	...
	public function enable_ingredients() {
		$enable_ingredients = of_get_option('enable_ingredients', 1);
		return isset( $enable_ingredients ) && $enable_ingredients ? 1 : 0;
	}	
