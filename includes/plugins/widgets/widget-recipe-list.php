...
/*-----------------------------------------------------------------------------------*/
	...
	function widget( $args, $instance ) {
		...
		$sort_by = isset($instance['sort_by']) ? (string)$instance['sort_by'] : 'title';
			...
			if (count($recipe_results) > 0 && $recipe_results['total'] > 0) { ?>
				...
				<!--//entries-->
					<div class="quicklinks">
						<a href="<?php echo esc_url ($sc_theme_globals->get_recipe_list_page_url()); ?>" class="button show-more-recipes"><?php _e('More recipes', 'socialchef'); ?></a>
