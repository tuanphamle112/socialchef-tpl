			...
			if ( ! empty( $user_query->results )) { 
				...
				<article class="entry"><?php
					...
					<figure>
						...
						<figcaption><a href="<?php echo esc_url ( $profile_link ); ?>"><i class="icon icon-themeenergy_eye2"></i> <span><?php _e('View member', 'socialchef'); ?></span></a></figcaption>
					</figure>
					<div class="container">
						<h2><a href="<?php echo esc_url ( $profile_link ); ?>"><?php echo $user_nicename; ?></a></h2>
						<?php if (!empty($block_quote)) { ?>
							<blockquote><i class="fa fa-quote-left"></i><?php echo $block_quote; ?></blockquote>
						<?php } ?>
						<div class="actions">
							<div>
