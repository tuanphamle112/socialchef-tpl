...
?>
				<ul class="social"> <?php
					if (!empty($facebook_id))
						echo '<li><a href="http://www.facebook.com/' . urlencode($facebook_id) . '" title="facebook"><i class="fa fa-fw fa-facebook"></i></a></li>';
					if (!empty($twitter_id))
						echo '<li><a href="http://twitter.com/' . urlencode($twitter_id) . '" title="twitter"><i class="fa fa-fw fa-twitter"></i></a></li>';
					if (!empty($rss_feed))
						echo '<li><a href="' . esc_url($rss_feed) . '" title="rss"><i class="fa fa-fw fa-rss"></i></a></li>';
					if (!empty($linked_in_profile))
						echo '<li><a href="' . esc_url($linked_in_profile) . '" title="linkedin"><i class="fa fa-fw fa-linkedin"></i></a></li>';
					if (!empty($gplus_profile))
						echo '<li><a href="' . esc_url($gplus_profile) . '" title="gplus"><i class="fa fa-fw fa-google-plus"></i></a></li>';
					if (!empty($youtube_profile))
						echo '<li><a href="' . esc_url($youtube_profile) . '" title="youtube"><i class="fa fa-fw fa-youtube"></i></a></li>';
					if (!empty($vimeo_profile))
						echo '<li><a href="' . esc_url($vimeo_profile) . '" title="vimeo"><i class="fa fa-fw fa-vimeo"></i></a></li>';
					if (!empty($pinterest_profile))
						echo '<li><a href="' . esc_url($pinterest_profile) . '" title="pinterest"><i class="fa fa-fw fa-pinterest-p"></i></a></li>';
					if (!empty($instagram_profile))
						echo '<li><a href="' . esc_url($instagram_profile) . '" title="instagram"><i class="fa fa-fw fa-instagram"></i></a></li>';						
					?>
				</ul>
			</article>
		<?php
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_profile' ) ); ?>"><?php _e('Instagram url:', 'socialchef') ?></label>
